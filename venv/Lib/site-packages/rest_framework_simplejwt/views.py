...
class CustomTokenRefreshView(TokenRefreshView):
    def post(self, request, *args, **kwargs):
        # Access the refresh token from the request data
        refresh_token = request.data.get('refresh')
        
        # Print the refresh token (for debugging purposes only)
        print("Incoming refresh token:", refresh_token)
        
        # Call the parent class's post method to continue with normal processing
